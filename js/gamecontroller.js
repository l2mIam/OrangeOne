				...
				dpad: {
					up: {
						...
						touchStart: function() {
							...
							GameController.simulateKeyEvent( 'down', 87 );
						},
						touchEnd: function() {
							GameController.simulateKeyEvent( 'up', 38 );
							GameController.simulateKeyEvent( 'up', 87 );
						}
					},
					left: {
						width: '15%',
						...
						touchStart: function() {
							...
							GameController.simulateKeyEvent( 'down', 65 );
						},
						touchEnd: function() {
							GameController.simulateKeyEvent( 'up', 37 );
							GameController.simulateKeyEvent( 'up', 65 );
						}
					},
					down: {
						width: '7%',
						...
						touchStart: function() {
							...
							GameController.simulateKeyEvent( 'down', 83 );
						},
						touchEnd: function() {
							GameController.simulateKeyEvent( 'up', 40 );
							GameController.simulateKeyEvent( 'up', 83 );
						}
					},
					right: {
						width: '15%',
						...
						touchStart: function() {
							...
							GameController.simulateKeyEvent( 'down', 68 );
						},
						touchEnd: function() {
							GameController.simulateKeyEvent( 'up', 39 );
							GameController.simulateKeyEvent( 'up', 68 );
						}
					}
				},
				joystick: {
